...
The abstract is the [README](README.md). Sources for all sections: [bibliography.bib](bibliography.bib).

## Sections

| § | Title | |
|---|---|---|
| 1 | A new data flow architecture | [01_introduction.md](01_introduction.md) |
| 2 | Sigma | [02_sigma.md](02_sigma.md) |
| 3 | The model | [03_the_model.md](03_the_model.md) |
| 4 | Grounding the constraints in the forces | [04_grounding.md](04_grounding.md) |
| 5 | Operations | [05_operations.md](05_operations.md) |
| 6 | Analysis | [06_analysis.md](06_analysis.md) |
| 7 | Future work | [07_future_work.md](07_future_work.md) |
| 8 | Gravity | [08_gravity.md](08_gravity.md) |

## Figures

Figure numbers are section-relative; file names carry the same number. Live figures are inline in their section.

| Figure | Title | In | Source |
|---|---|---|---|
...
| 3.4 | Hierarchical topology | [§3.8.1](03_the_model.md) | [fig-3.4-topology.png](figures/fig-3.4-topology.png) |
| 3.5 | Working on forks | [§3.8.2](03_the_model.md) | inline |
| 6.1 | Awareness is quadratic | [§6.4.2](06_analysis.md) | [fig-6.1-awareness-quadratic.png](figures/fig-6.1-awareness-quadratic.png) |
